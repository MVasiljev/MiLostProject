...
use milost_ui::{
    components::{
        UIComponent,
        stack::{VStackProps, VStackAlignment, LayoutPriority},
    },
...
impl VStack {
    ...
    pub fn alignment(mut self, alignment_str: &str) -> Self {
        let alignment = match alignment_str {
            "leading" => VStackAlignment::Leading,
            "center" => VStackAlignment::Center,
            "trailing" => VStackAlignment::Trailing,
            _ => VStackAlignment::Leading,
        };
    ...
    pub fn to_json(&self) -> String {
        serde_json::to_string(&UIComponent::VStack(self.props.clone()))
