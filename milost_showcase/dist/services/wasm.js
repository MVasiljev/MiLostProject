...
import os from "os";
import { initWasm, getWasmModule, isWasmInitialized, setExternalWasmInstance, } from "milost";
...
export async function initializeWasm() {
    try {
        ...
        const wasmBinaryPath = path.resolve(dirname, "../../node_modules/milost/dist/wasm/milost_wasm_bg.wasm");
        const wasmJsPath = path.resolve(dirname, "../../node_modules/milost/dist/wasm/milost_wasm.js");
        ...
        if (wasmModule) {
            for (const moduleName of Object.keys(moduleStatus)) {
                const moduleExists = typeof wasmModule[moduleName] === "function" ||
                    ...
                    try {
                        ...
                        if (typeof wasmModule[moduleName] === "function") {
                            Object.getOwnPropertyNames(wasmModule[moduleName])
                                .filter((name) => typeof wasmModule[moduleName][name] === "function" &&
                                name !== "constructor")
                        ...
                        else if (typeof wasmModule[moduleName] === "object" &&
